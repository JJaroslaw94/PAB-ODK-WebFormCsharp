<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EdySt.aspx.cs" Inherits="PAB_Obsluga_Dzialu_Kadr_Web.EdySt" %>
...
<body>
    <form id="form1" runat="server">
        <div class="CentrujacyDIV2">
            <asp:Label ID="Label2" runat="server" Text="Edytowanie Stanowiska"></asp:Label>
            ...
            <div class="PrzerwaMiedzyLiniami">
                ...
                <asp:Button ID="ButtonDodStD" runat="server" Text="Usuń" OnClick="ButtonDodStU_Click" />
                <asp:Button ID="ButtonDodStD0" runat="server" Text="Edytuj" OnClick="ButtonDodStE_Click" />
            </div>
        </div>
