<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DodOf.aspx.cs" Inherits="PAB_Obsluga_Dzialu_Kadr_Web.DodOf" %>
...
<body>
    <form id="form1" runat="server">
        <div class="CentrujacyDIV2">
            <asp:Label ID="Label2" runat="server" Text="Dodawanie Oferty"></asp:Label>
            <div class="PrzerwaMiedzyLiniami">
                <asp:Label ID="Label1" class="CentrowaneLewe" runat="server" Text="Stanowisko"></asp:Label>
            ...
            <div class="PrzerwaMiedzyLiniami2">
                <asp:Label ID="Label3" class="CentrowaneLewe" runat="server" Text="Opis"></asp:Label>
            ...
            <div class="PrzerwaMiedzyLiniami2">
                <asp:Label ID="Label5" class="CentrowaneLewe" runat="server" Text="Wymogi"></asp:Label>
            ...
            <div class="PrzerwaMiedzyLiniami">
                <asp:Label ID="Label6" class="CentrowaneLewe" runat="server" Text="Wynagrodzenie"></asp:Label>
                <asp:TextBox ID="TextBox4" CssClass="CentrowanePrawe" runat="server" ></asp:TextBox>
            </div>
            <div class="PrzerwaMiedzyLiniami">
                <asp:Label ID="Label7" class="CentrowaneLewe" runat="server" Text="Dostępne miejsca"></asp:Label>
            ...
            <div class="PrzerwaMiedzyLiniami">
                ...
                <asp:Button ID="ButtonDodOfD" runat="server" Text="Dodaj" OnClick="ButtonDodOfD_Click" />
            </div>
        </div>
